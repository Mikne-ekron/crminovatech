...
// Lista de notificaciones (fuente de verdad del backend) + contador de no leídas.
// El sondeo periódico asegura que los admin vean los eventos en segundos aunque
// el push no llegue o el dispositivo no esté instalado.
