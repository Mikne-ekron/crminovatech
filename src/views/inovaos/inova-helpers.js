...
export const ETIQUETAS = {
  capturado: 'Capturado', delegado: 'Delegado', aceptado: 'Aceptado',
  en_progreso: 'En progreso', en_espera: 'En espera', concluido: 'Concluido',
  aprobado: 'Aprobado', reagendado: 'Reagendado',
};
...
export function diasRestantes(fecha) {
  ...
  const f = new Date(String(fecha).slice(0, 10) + 'T12:00:00'); f.setHours(0, 0, 0, 0);
