...
<template>
    <div class="print-view">
        ...
        <div class="print-toolbar no-print">
            <v-btn variant="text" prepend-icon="mdi-arrow-left" @click="close">Cerrar</v-btn>
            <v-spacer></v-spacer>
            <v-btn color="primary" prepend-icon="mdi-printer" @click="print" :disabled="loading || !detail">
                Imprimir
            </v-btn>
        </div>
        ...
        <div v-else-if="detail" class="quote-paper mx-auto">
            ...
            <v-row class="mb-6">
                <v-col cols="6">
                    ...
                    <p class="text-h6 font-weight-bold mb-0">{{ detail.header.Cliente }}</p>
                ...
                <v-col cols="6" class="text-right">
                    ...
                    <p class="text-caption text-medium-emphasis" v-if="detail.header.Moneda !== 'MXN'">
